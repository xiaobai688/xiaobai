...
<body>
		...
		<div id="page-wrapper">
			...
			<div class="panel panel-default">
				<div class="panel-body">
					<form class="form-inline" action="${pageContext.request.contextPath }/customer/queryAllCustomer" method="get">
						...
						<a href="#" class="btn btn-primary btn-xs" data-toggle="modal" data-target="#customerAddDialog" onclick="editCustomer()">新增客户</a>
					</form>
				</div>
			</div>
			<div class="row">
				<div class="col-lg-12">
					<div class="panel panel-default">
						...
						<div class="col-md-12 text-right">
							<itcast:page url="${pageContext.request.contextPath }/customer/queryAllCustomer" />
						</div>
						<!-- /.panel-body -->
					</div>
					<!-- /.panel -->
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				<div class="modal-header">
					...
					<h4 class="modal-title" id="myAddModalLabel">新增客户信息</h4>
				</div>
				<div class="modal-body">
				...
				<div class="modal-footer">
					<button type="button" class="btn btn-default" data-dismiss="modal">关闭</button>
					<button type="button" class="btn btn-primary" onclick="addCustomer()">增加</button>
				</div>
			</div>
		</div>
	</div>
	...
	<script type="text/javascript">
		...
		function updateCustomer() {
			$.post("${pageContext.request.contextPath }/customer/update",$("#edit_customer_form").serialize(),function(data){
				if(data == "0"){
					alert("客户信息更新成功！");
				}else{
					alert("客户信息更新失败！");
		...
		function addCustomer() {
			$.post("${pageContext.request.contextPath }/customer/addCustomer",$("#add_customer_form").serialize(),function(data){
				if(data == "0"){
					alert("客户信息增加成功！");
				}else{
					alert("客户信息增加失败！");
		...
		function deleteCustomer(id) {
			if(confirm('确实要删除该客户吗?')) {
				$.post("${pageContext.request.contextPath }/customer/delete",{"id":id},function(data){
					if(data == "0"){
						alert("客户信息删除成功！");
					}else{
						alert("客户信息删除失败！");
